 ...
 do
 {
  ...
  case 4:
   ...
   break;
    case 7:
      int roll;
      cout<<"Please Enter the ID of Employee Whose Info You Want to Delete: ";
     cin>>roll;
     f.open("EmpRecord.txt",ios::in);
    ...
    cout << "The record with the ID " << roll << " has been deleted " << endl;
     f.close();
     g.close();
     remove("EmpRecord.txt");
     rename("temp1.txt","EmpRecord.txt");
      break;
    case 8:
       cout<<"\n\tThank you";
       break;
